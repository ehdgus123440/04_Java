...
public class TryCatchFinallyService {
	 ...
	 * 
	 * catch(처리할 예외 객체 참조 변수){} : try에서 던져진 예외 객체를 잡아서 처리하는 구문 -> 예외가 처리되어(없어져)
	 * 프로그램이 강제 종료 되지 않음!!!
	 * 
	 * finally{} : try 구문에서 예외 발생 여부 상관 없이 무조건 마지막에 실행되어야 하는 코드를 작성하는 구문
	 */
	 ...
	 * finally는 언제 사용할까??
	 * 
	 * * Java 프로그램 - 외부 프로그램/장치 둘의 연결을 무조건 끊어야할 때 주로 사용
	 */
	public void test2() {
